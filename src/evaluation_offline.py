...
def run_offline_evaluation():
    ...
    with open("saved_outputs/agentic_answer_1.txt", "r", encoding="utf-8") as file:
        agentic_answer = file.read()

    baseline_bleu = calculate_bleu(reference_answer, baseline_answer)
    agentic_bleu = calculate_bleu(reference_answer, agentic_answer)

    baseline_rouge = calculate_rouge(reference_answer, baseline_answer)
    agentic_rouge = calculate_rouge(reference_answer, agentic_answer)
    ...
    results = [
        {
            ...
            "query": query,
            "evaluation_mode": "offline_saved_agentic_output",
    ...
    output_path = "evaluation_results/evaluation_report_offline.csv"
